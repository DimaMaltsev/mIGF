...
public class ColliderSetupper : MonoBehaviour {
	...
	void Start () {
		...
		p.points = new Vector2[]{ 
			Vector2.up/2.5f, Vector2.right/3 + Vector2.up/4 , Vector2.right/2.4f, Vector2.right/2.4f - Vector2.up/6f, Vector2.right/2.6f - Vector2.up/2.2f, Vector2.right/3.5f - Vector2.up/2.1f,
